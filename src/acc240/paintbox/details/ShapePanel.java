    ...
    public final void reload(int type, Shape caller) {
        ...
        switch (type) {
            case CornerShape:
                ...
                fields.get(0).add(new JTextField("" + ((acc240.paintbox.geom.CornerShape) caller).getTopCorner().x));
            ...
            case Picture:
                ...
                fields.get(0).add(new JTextField("" + ((acc240.paintbox.geom.Picture) caller).getWidth()));
                fields.get(0).get(0).addActionListener(listener);
                fields.get(0).get(0).setMaximumSize(new Dimension(50, 20));
            ...
            case Text:
                ...
                fields.get(0).add(new JTextField("" + ((acc240.paintbox.geom.Text) caller).getText()));
                fields.get(0).get(0).addActionListener(listener);
                fields.get(0).get(0).setMaximumSize(new Dimension(50, 20));
